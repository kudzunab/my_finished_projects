...
def from_entity(entity: GameEntity) -> Tuple[Game, str]:
    game_domain = Game(game_id=entity.UUID, field=copy.deepcopy(entity.field),
                       turn=entity.turn, status=entity.status, game_type=entity.game_type, current_player_uuid=entity.current_player_uuid,
                       player1_uuid=entity.player1_uuid, player2_uuid=entity.player2_uuid)

    game_domain.snapshot = copy.deepcopy(entity.field)
    game_domain.status = entity.status
    game_domain.player1_symbol = entity.player1_symbol
    game_domain.player2_symbol = entity.player2_symbol
